...
public class MonitoramentoAmbientalApp {

    private static final Logger log = LoggerFactory.getLogger(MonitoramentoAmbientalApp.class);

    private final Environment env;

    public MonitoramentoAmbientalApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes monitoramentoAmbiental.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MonitoramentoAmbientalApp.class);
